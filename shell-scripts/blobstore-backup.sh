...
backup_folder_static="static.pratilipi.com/$(date +%d)/static.pratilipi.com-$(date +%H:%M-IST)"
backup_folder_public="public.pratilipi.com/$(date +%d)/public.pratilipi.com-$(date +%H:%M-IST)"
