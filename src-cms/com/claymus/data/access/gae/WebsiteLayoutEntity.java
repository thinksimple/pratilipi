...
@PersistenceCapable( table = "WEBSITE_LAYOUT" )
public class WebsiteLayoutEntity implements PageLayout {
	
	@PrimaryKey
	@Persistent( column = "WEBSITE_LAYOUT_ID", valueStrategy = IdGeneratorStrategy.IDENTITY )
	private Long id;
