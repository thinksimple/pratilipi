...
public class PratilipiHelper extends ClaymusHelper {
	...
	public PratilipiData createPratilipiData(
		...
		pratilipiData.setCoverImageUrl( URL_RESOURCE_STATIC + "pratilipi-cover/300/" + pratilipi.getId() + "?" + pratilipi.getLastUpdated().getTime() );
		...
		pratilipiData.setRelevance( ( author == null ? 0 : author.getContentPublished() ) + pratilipi.getReadCount() + pratilipi.getRelevanceOffset() );
