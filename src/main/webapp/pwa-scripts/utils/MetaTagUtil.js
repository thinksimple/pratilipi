...
var MetaTagUtil = (function() {
	return {
		setMetaTagsForPratilipi: function( pratilipi ) {
			...
			metaTagArray.push( new metaTag( "og:url", "http://" + pratilipi.language.toLowerCase() + ".pratilipi.com" + pratilipi.pageUrl ) );
			...
			metaTagArray.push( new metaTag( "books:author", "http://" + pratilipi.language.toLowerCase() + ".pratilipi.com" + pratilipi.author.pageUrl ) );
