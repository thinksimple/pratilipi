			...
			<div class="secondary-500" style="margin-left: 150px;">
				<div class="media">
					...
					<div class="media-body">
						...
						<p><b>Sorry! Looks like something is wrong with our server.</b></p>
						<p><b>Please try again after a few minutes, or use the search bar to find<br>
						great content, or just head over to the Pratilipi homePage.</b></p> <br>
