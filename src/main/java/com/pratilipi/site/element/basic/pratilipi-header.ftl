	...
	<div class="row" style="text-align: center; margin: 0 auto;">
		...
		<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2" >
			<a style="display: block;" href="/navigation">
				<svg viewBox="0 24 24 24" class="svg-icon edit-icon">
				  <use xlink:href="/resources/icons.svg#ic_assignment_returned_black_24px"></use>
				</svg>
			</a>
		</div>
		<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
			<a style="display: block;" onclick="showPopup()" >
				<svg viewBox="0 0 24 24" class="svg-icon edit-icon">
				  <use xlink:href="/resources/icons.svg#ic_account_balance_black_24px"></use>
				</svg>
			</a>
		</div>
		<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
