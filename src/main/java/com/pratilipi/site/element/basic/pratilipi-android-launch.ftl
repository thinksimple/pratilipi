<div id="androidSubsribeAlert" class="container alert alert-warning alert-dismissible fade in" style="z-index: 1;margin-bottom: 0; border-radius: 0; cursor: pointer; padding: 0; color: #fff; background-color: #bb0118; border: none; margin-left: -5px; margin-right: -5px; display: none;" role="alert">
