...
<div class="secondary-500 pratilipi-shadow box text-center">
	...
	<div class="fb-like" data-href="http://${ language }.pratilipi.com${ pratilipi.getPageUrl() }" data-layout="button" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
