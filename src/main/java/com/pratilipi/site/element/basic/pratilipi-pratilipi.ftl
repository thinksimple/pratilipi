...
<div class="secondary-500 pratilipi-shadow box text-center">
	...
	<div style="padding-top: 20px; padding-bottom: 20px;">
		...
		<br />
		<a style="margin-left: 7px;" data-behaviour="share_whatsapp" href="whatsapp://send?text=I+Found+this+book+nice+%0Ahttp%3A%2F%2F${ language?lower_case }.pratilipi.com${ pratilipi.getPageUrl()?url }"><img style="width:40px;height:40px;" class="img-circle" src="http://0.ptlp.co/resource-all/home-page/WhatsAppLogo.png"></a>
		<#if userpratilipi?? && userpratilipi.isAddedtoLib()??>
