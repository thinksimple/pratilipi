...
<div style="padding-top:25px; padding-bottom:25px;">
	<div class="row" style=" text-align: center;">
	    ...
	    <#if rating1 == pratilipiListPageCurr>
	    	<div class="col-xs-2 col-xs-offset-1"><a style="color: #333; font-size: 16px;" href="?page=${ rating1 }">${ rating1 }</a></div>
		<#else>
    	...
    	<#if rating2?? >
    		<#if rating2 == pratilipiListPageCurr>
    			<div class="col-xs-2"><a style="color: #333; font-size: 16px;" href="?page=${ rating2 }">${ rating2 }</a></div>
    		<#else>
	    ...
	    <#if rating3?? >
	    	<#if rating3 == pratilipiListPageCurr>
    			<div class="col-xs-2"><a style="color: #333; font-size: 16px;" href="?page=${ rating3 }">${ rating3 }</a></div>
    		<#else>
	    ...
	    <#if rating4?? >
	    	<#if rating4 == pratilipiListPageCurr>
    			<div class="col-xs-2"><a style="color: #333; font-size: 16px;" href="?page=${ rating4 }">${ rating4 }</a></div>
    		<#else>
	    ...
	    <#if rating5?? >
	    	<#if rating5 == pratilipiListPageCurr>
    			<div class="col-xs-2"><a style="color: #333; font-size: 16px;" href="?page=${ rating5 }">${ rating5 }</a></div>
    		<#else>
