...
public class MockData {
	...
	static {
		...
		// GLOBAL_INDEX
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( hiPratilipi_1, hiAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( hiPratilipi_2, hiAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( hiPratilipi_3, hiAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( guPratilipi_1, guAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( guPratilipi_2, guAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( guPratilipi_3, guAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( taPratilipi_1, taAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( taPratilipi_2, taAuthor_1 ) );
		GLOBAL_INDEX.add( PratilipiDataUtil.createData( taPratilipi_3, taAuthor_1 ) );
