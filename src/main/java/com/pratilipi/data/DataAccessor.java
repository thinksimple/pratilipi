...
public interface DataAccessor {
	...
	DataListCursorTuple<Long> getAuthorIdListWithMaxReadCount( Language language, Long minReadCount, String cursorStr, Integer resultCount );
	...
	DataIdListIterator<Email> getEmailIdIteratorWithStatePending();
