package com.pratilipi.api.impl.recommend;
...
@Bind( uri = "/recommend" )
public class RecommendApi extends GenericApi {
	...
	public GenericResponse get( GetRequest request ) throws InsufficientAccessException {
		...
		for( String listName : dataAccessor.getRecommendSectionList( request.language ) ) {
