...
public class UserAccessUtil {
	...
	private enum Role {
		...
		ADMIN_BENGALI	( Language.BENGALI,		AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
		ADMIN_HINDI		( Language.HINDI,		AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
		ADMIN_GUJARATI	( Language.GUJARATI,	AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
		ADMIN_MALAYALAM	( Language.MALAYALAM,	AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
		ADMIN_MARATHI	( Language.MARATHI,		AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
		ADMIN_TAMIL		( Language.TAMIL,		AccessType.PRATILIPI_LIST, AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE ),
