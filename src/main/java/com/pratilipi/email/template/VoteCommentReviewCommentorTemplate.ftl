...
<table align="left" table-layout="fixed;" style="width: 100%; height: 100%;">
	<tr>
		<td>
			<p data-key="email_vote_comment_review_commentor_heading" style="margin: 15px 0 10px 0; color: #000; font-size: 16px;">${"$"}{ vote_name } has liked your comment on ${"$"}{ pratilipi_title }.</p>
		</td>
	</tr>
</table>
