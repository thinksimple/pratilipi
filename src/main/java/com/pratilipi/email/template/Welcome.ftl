<table style="width: 100%; text-align: center;">
	<tr>
		<td>
			<h2 style="margin: 0.75em 0 0.75em 0; color: #D0021B;">Welcome to Pratilipi !</h2>
		</td>
	</tr>
	<tr>
		<td>
...
<table style="width: 90%; margin: 24px auto;">
	<tr>
		<td style="width: 100%;">
			<div>
				<img src="http://public.pratilipi.com/email/welcome/read.png" style="width: 24px; height: 24px; margin: 0px 10px 0 0; float: left;"/>
				<p style="color: #D0021B; margin: 0px; display: inline-block; font-size: 20px; position: relative;">Read</p>
			...
			<div>
				...
				<p style="color: #D0021B; margin: 0px; display: inline-block; font-size: 20px; position: relative;">Write</p>
			...
			<div>
				...
				<p style="color: #D0021B; margin: 0px; display: inline-block; font-size: 20px; position: relative;">Connect</p>
