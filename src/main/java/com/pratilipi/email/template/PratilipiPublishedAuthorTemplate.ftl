...
<table align="left" table-layout="fixed;" style="width: 100%; height: 100%;">
	<tr>
		<td>
			<p data-key="email_pratilipi_published_author_heading" style="margin: 15px 0 10px 0; color: #000; font-size: 16px;">Your story <b>${"$"}{ pratilipi_title }</b> has been published.</p>
		</td>
	</tr>
</table>
