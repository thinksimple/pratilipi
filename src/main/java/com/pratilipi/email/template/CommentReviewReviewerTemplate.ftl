...
<table align="left" table-layout="fixed;" style="width: 100%; height: 100%;">
	<tr>
		<td>
			<p data-key="email_comment_review_reviewer_heading" style="margin: 15px 0 10px 0; color: #000; font-size: 16px;">${"$"}{ comment_name } has commented on your review of <b>${"$"}{ pratilipi_title }</b></p>
		</td>
	</tr>
</table>
