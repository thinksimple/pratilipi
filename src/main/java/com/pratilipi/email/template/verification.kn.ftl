...
<#-- SUBJECT: ದಯವಿಟ್ಟು ನಿಮ್ಮ ಇ-ಮೇಲ್ ವಿಳಾಸವನ್ನು ಪರಿಶೀಲಿಸಿ  -->
											...
											<tr>
												<td>
													<center>
														...
														<div>
															<p style="margin: 0.75em 0 0.75em 0; font-size: 16px;">ನಮಸ್ತೆ ${ user_display_name }</h2>
															<p style="margin: 0; font-size: 16px;">ಪ್ರತಿಲಿಪಿಗೆ ಸೇರುತ್ತಿರುವುದಕ್ಕೆ ಧನ್ಯವಾದಗಳು. ನಿಮ್ಮ ಖಾತೆಯನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲು ದಯವಿಟ್ಟು ಕೆಳಗಿನ ಲಿಂಕ್ ಮೇಲೆ ಕ್ಲಿಕ್ ಮಾಡಿ </p>
														</div>
													</center>
												</td>
											</tr>
										...
										<table align="center" cellspacing="0" cellpadding="0" table-layout="fixed;" style="margin: 0 auto;"> 
											<tr>
												<td align="center" width="auto" height="40" bgcolor="#FF0000" style="-webkit-border-radius: 5px; -moz-border-radius: 5px;border-radius: 5px; color: #ffffff; display: block;">
													<a href="http://kannada.pratilipi.com${ emailVerificationUrl }" target="_blank" style="font-size: 18px; text-decoration: none; line-height: 40px; width: 100%; display: inline-block;">
												...
												<td>
													<center>
														<div>
															...
															<a href="http://kannada.pratilipi.com${ emailVerificationUrl }" target="_blank" style="color: #4a4a4a; text-decoration: underline;">
																<br/>
																<small>
																	http://kannada.pratilipi.com${ emailVerificationUrl }
																</small>
															</a>
														</div>
													</center>
