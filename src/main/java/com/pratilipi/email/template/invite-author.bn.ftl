							...
							<td>
								...
								<table style="width: 100%; padding: 0px; border-spacing: 0; margin: 0 auto;">
									<tr>
										...
										<a href="http://bengali.pratilipi.com" target="_blank" style="font-size: 18px; text-decoration: none; line-height: 40px; width: 100%; display: inline-block; background-color: #D0021B; border-radius: 2px;">
