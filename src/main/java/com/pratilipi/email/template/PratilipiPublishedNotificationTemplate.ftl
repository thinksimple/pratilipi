				...
				<tr>
					...
					<td width="100%">
						<table style="border-collapse: collapse;">
							...
							<tr>
								<td>
									<a href="${ author_page_url }" style="color: #c7c7c7; text-decoration: none; font-size: 14px; line-height: 19px; font-weight: bold;" target="_blank">
										${ author_name }
									</a>
								</td>
							</tr>
							<tr>
								<td>
									<span style="font-size: 14px; line-height: 19px; color: #646464;">${ pratilipi_listing_date }</span>
								</td>
							</tr>
						</table>
					</td>
